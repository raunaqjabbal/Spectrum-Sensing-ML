...
class Classification:
    ...
    def __init__(self, X_train=None,y_train=None,X_test=None,y_test=None,Samples=50,SU=3,X_test_2=None,SNR=None, name=None,marker=None,color=None):
    ...
    def MLP(self):
        ...
        return[fpr,tpr,auc,type,self.color,self.marker,int((len(fpr))*0.037)]
    ...
    def RandomForest(self):
        ...
        if(len(fpr)>500):
            ...
            val=1
        return[fpr,tpr,auc,type,self.color,self.marker,val]
    ...
    def OR(self):
        ...
        auc = metrics.auc(fpr,tpr)
        return[fpr,tpr,auc,type,self.color,self.marker,int((len(fpr))*0.01)]
